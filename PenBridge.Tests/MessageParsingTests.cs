...
public class MessageParsingTests
{
    ...
    {
        Assert.True(PenBridgeServer.TryParseSample(Valid, out var sample, out _));
    ...
    public void Missing_protocol_version_is_rejected()
    {
        ...
        Assert.False(PenBridgeServer.TryParseSample(json, out _, out string? error));
    ...
    public void Mismatched_protocol_version_is_rejected()
    {
        ...
        Assert.False(PenBridgeServer.TryParseSample(json, out _, out _));
    }
    ...
    {
        Assert.False(PenBridgeServer.TryParseSample("{not json at all", out _, out _));
    }
    ...
    public void Missing_optional_tilt_defaults_to_zero()
    {
        ...
        Assert.True(PenBridgeServer.TryParseSample(json, out var sample, out _));
